...
function immocaster_theme_resultlist_office($aEntry)
{
	$sCode = '';
	...
	$sCode .= '<span class="label">'.__('Office space',IMMOCASTER_PO_TEXTDOMAIN).':</span>&nbsp;';
	$sCode .= '<span class="value">'.$aEntry['officeSpace'].'&nbsp;'.__('m²',IMMOCASTER_PO_TEXTDOMAIN).'</span>';
	$sCode .= '</div>';
